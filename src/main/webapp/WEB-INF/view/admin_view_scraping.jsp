...
<div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link"
                               href="${pageContext.request.contextPath}/admin/competitors">Competitors</a>
                        </li>
                    </ul>
                </ul>
    ...
    <nav class="navbar navbar-light" style="background-color: #282838;">
        <div class="container">
            <label style="font-size: 25px; font-weight: bold; margin: 15px auto; color: white">Competitors rates</label>
        </div>
    </nav>
</div>
<div>
    ...
    <div>
        <div class="container-sm mt-5">
            <form:form method="get" modelAttribute="scrape" id="scrapeForm">
                <div class="col-lg-10 col-md-10 col-sm-10 container justify-content-center">
                    <div class="table-responsive rounded-3 mt-3">
                        <table class="table table-dark table-hover">
                            ...
                            <tbody>
                            <c:forEach items="${scrape}" var="scrape">
                                <tr>
                                    <td>${scrape.vehicleModel}</td>
                                    <td>${scrape.rate}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
